...
public class NamespaceListDecl extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public NamespaceListDecl (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NamespaceListDecl(\n");
