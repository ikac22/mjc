...
public class ClassNoInitList implements SyntaxNode {
    ...
    public ClassNoInitList (ClassName ClassName, Extend Extend, StaticDecl StaticDecl, VarDeclList VarDeclList, ClassMethods ClassMethods) {
